        ...
        child: Container(
          ...
          child: Row(
            children: [
              ...
              getSvgImageWithSize(context, "arrow-down.svg",16.h,16.h,color: getFontColor(context))
      ...
      child: ClipRRect(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              // margin: EdgeInsets.symmetric(horizontal: 16),
              child:getDefaultTextFiled(context, "", textController, getFontColor(context), (value) { },withPrefix: true,imgName: "search.svg")
              // TextField(
              //   autofocus: true,
